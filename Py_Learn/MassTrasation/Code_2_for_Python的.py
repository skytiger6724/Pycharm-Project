...
if False:
    ...
    print(u"***********1.3 经典类classic classes和新式类new-style classes的区别**********")
...
if False:
    ...
    print('func name is {}:'.format(for_generate_list.__name__))  # func name is for_generate_list:

    print(u"***********#   *************")

# 2.9 多进程和多线程的提速方案
if False:
    print(u"***********# 多进程和多线程的提速方案 *************")
